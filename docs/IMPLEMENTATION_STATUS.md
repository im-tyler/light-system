...
- City steady state (2026-09-07 23:15, parallel traversal/build, 8 threads, machine loaded ~20): traverse 2.4-2.7ms (was 3.9 serial same load), residency 0.15-0.2ms, build 1.3-1.5ms (was 1.9), upload 0.1-0.2ms, cmdrec 0.02ms, submit 1.9-2.2ms (was 6.6-6.9ms with per-cluster draws; the remainder is MoltenVK's fixed command-stream encode cost, no longer draw-count driven), fence 1.5-2.2ms (GPU execution). Idle-machine rerun pending.
